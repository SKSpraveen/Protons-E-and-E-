...
function StockDetails() {
    ...
    return (
        <div>
            ...
            <div className="row">
                <div className="col-lg-3 mt-2 mb-2" style={{ display:"flex",alignItems: "center", marginLeft:"640px"}}>
           ...
           <div style={{  display: "flex"}}>
            ...
            <button className="pdf-btnSM" style={{marginLeft:"81%"}} onClick={generatePDF}> <i class="fa fa-download" aria-hidden="true"></i> Export to PDF</button>
            <br /> <br />
